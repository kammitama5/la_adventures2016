...
class AdventuresControllerTest < ActionController::TestCase
  ...
  test "should create adventure" do
    assert_difference('Adventure.count') do
      post :create, adventure: { description: @adventure.description, location: @adventure.location, name: @adventure.name, picture: @adventure.picture, visit: @adventure.visit }
    end
  ...
  test "should update adventure" do
    patch :update, id: @adventure, adventure: { description: @adventure.description, location: @adventure.location, name: @adventure.name, picture: @adventure.picture, visit: @adventure.visit }
    assert_redirected_to adventure_path(assigns(:adventure))
  end
